...
const char *vc_mod_id_name(__u16 mod_id)
{
        switch (mod_id) {
        case MOD_ID_IMX178: return "IMX178";
        case MOD_ID_IMX183: return "IMX183";
        case MOD_ID_IMX226: return "IMX226";
        case MOD_ID_IMX250: return "IMX250";
        case MOD_ID_IMX252: return "IMX252";
        case MOD_ID_IMX264: return "IMX264";
        case MOD_ID_IMX265: return "IMX265";
        case MOD_ID_IMX273: return "IMX273";
        case MOD_ID_IMX290: return "IMX290";
        case MOD_ID_IMX296: return "IMX296";
        case MOD_ID_IMX297: return "IMX297";
        case MOD_ID_IMX327: return "IMX327";
        case MOD_ID_IMX335: return "IMX335";
        case MOD_ID_IMX392: return "IMX392";
        case MOD_ID_IMX412: return "IMX412";
        case MOD_ID_IMX415: return "IMX415";
        case MOD_ID_IMX462: return "IMX462";
        case MOD_ID_IMX540: return "IMX540";
        case MOD_ID_IMX565: return "IMX565";
        case MOD_ID_IMX566: return "IMX566";
        case MOD_ID_IMX567: return "IMX567";
        case MOD_ID_IMX568: return "IMX568";
        case MOD_ID_IMX585: return "IMX585";
        case MOD_ID_IMX900: return "IMX900";
        case MOD_ID_OV7251: return "OV7251";
        case MOD_ID_OV9281: return "OV9281";
        default: return NULL;
        }
}

bool vc_mod_id_supported(__u16 mod_id)
{
        return vc_mod_id_name(mod_id) != NULL;
}

int vc_mod_ctrl_init(struct vc_ctrl* ctrl, struct vc_desc* desc, __u16 mod_id)
{
        struct device *dev = &ctrl->client_mod->dev;
        ...
        default:
                vc_err(dev, "%s(): Module profile 0x%04x is not supported!\n",
                        __FUNCTION__, mod_id);
                return -EINVAL;
        }
